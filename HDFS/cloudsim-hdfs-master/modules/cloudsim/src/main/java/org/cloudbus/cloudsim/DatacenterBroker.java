...
/**
 * DatacenterBroker نشان دهنده کارگزاری است که از طرف یک کاربر عمل می کند.
 * مدیریت VM و همچنین ایجاد vm، ارسال ابر کلود به ماشین های مجازی و نابودی ماشین های مجازی را مخفی می کن
 * 
...
public class DatacenterBroker extends SimEntity {
	...
	protected void createVmsInDatacenter(int datacenterId) {
		...
		for (Vm vm : getVmList()) {
			// se la vm non è stata già allocata a nessun datacenter
